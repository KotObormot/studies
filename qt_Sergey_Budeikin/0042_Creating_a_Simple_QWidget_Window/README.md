...
To avoid manually creating a .desktop file on each computer, add automatic shortcut creation directly to your CMakeLists.txt file. Since you're using CMake, we can make it so that every time you launch a project from Qt Creator, a .desktop shortcut is created automatically, and the paths to the executable file in both your project and the console are set automatically.
============================================
